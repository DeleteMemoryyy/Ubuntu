...
void initialize(struct Set *set)
{
...
int exist(struct Set *set, Pointer_64 iTag, int time)
{
    for (int i = 0; i < E; ++i)
...
int replace(struct Set *set, Pointer_64 iTag, int time)
{
...
# 129 "csim.c"
    ...
    struct Set *set = (struct Set *)malloc(sNumber * sizeof(struct Set));
